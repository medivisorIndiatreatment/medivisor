              ...
              <form onSubmit={onSubmit} className="space-y-5" noValidate>
                <div className="grid gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input className="border-gray-300 py-1" id="name" name="name" value={form.name} onChange={onChange} placeholder="Jane Doe" required />
                  </div>

                  <div className="grid gap-2">
                    <Label htmlFor="email">Email</Label>
                    <Input className="border-gray-300 py-1"
                      id="email"
                      type="email"
                      name="email"
                      value={form.email}
                  ...
                  <div className="grid ">
                    ...
                    <div className="grid ">
                      <select
                        ...
                        className="h-10 w-full mt-1 rounded-md border border-r-0 border-gray-300 py-1 bg-muted px-3 text-sm "
                      >
                        {countries.map((c) => (
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="flex gap-x-3">
                      <select
                        ...
                        className="h-10 w-20 rounded-md border border-gray-300 py-1 bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                      >
                      ...
                      <Input className="border-gray-300 py-1 rounded-l-none"
                        id="whatsapp"
                        name="whatsapp"
                        inputMode="numeric"
                        pattern="[0-9]*"
                  ...
                  <div className="grid gap-2">
                    ...
                    <Textarea
                      className="border-gray-300 py-1"
                      id="message"
                      name="message"
                      value={form.message}
                      onChange={onChange}
